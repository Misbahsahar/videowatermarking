...
/**
 * This is the item provider adapter for a {@link videowatermarking.User} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UserItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						VideowatermarkingPackage.Literals.USER__NAME, true, false, false,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						VideowatermarkingPackage.Literals.USER__ID, true, false, false,
	...
	protected void addFrameNoPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_User_FrameNo_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_User_FrameNo_feature", "_UI_User_type"),
						VideowatermarkingPackage.Literals.USER__FRAME_NO, true, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	protected void addVideoPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_User_video_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_User_video_feature", "_UI_User_type"),
						VideowatermarkingPackage.Literals.USER__VIDEO, true, false, true, null, null, null));
	}
